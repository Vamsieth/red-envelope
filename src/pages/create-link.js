            ...
            <div className="font-[Montserrat] mx-6">
                <form className="flex gap-8 flex-col" onSubmit={handleFormSubmit}>
                    <div data-aos-delay={100} data-aos="fade-up" className="flex flex-col gap-2">
                        <label className="text-[#FF8A00] font-semibold text-sm uppercase">Enter funds to be added *</label>
                    ...
                    >
                        <div data-aos-delay={200} data-aos="fade-up" className="flex flex-col gap-2">
                            <label className="text-[#FF8A00] font-semibold text-sm uppercase">Time Limit *</label>
                    ...
                    <div data-aos-delay={300} data-aos="fade-up" className="flex flex-col gap-2">
                        <label className="text-[#FF8A00] font-semibold text-sm w-full flex justify-between items-center">
                    ...
                    <div className="my-4 flex ">
                        ...
                        >
                            <Popconfirm
                                ...
                                placement="top"
                            >
                                <button type="button" className="bg-[#FF8A00] rounded-sm flex gap-2 px-3 py-2 items-center font-semibold">Generate Link <AiOutlineArrowRight className="text-xl" /></button>
                            </Popconfirm>
                        </ConfigProvider>
                    </div>
                </form>
                ...
                >
                    <div className="pt-4">
                        <div className="flex items-center justify-center flex-col h-full my-6">
                            <div id="qr-code">
                                <QRCode size={170} value={share_url} color="#FF8A00" bgColor="#0b0a0a" />
                            </div>
